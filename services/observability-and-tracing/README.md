...
| [OrcaReplay](orcareplay.md) [![⭐](https://img.shields.io/github/stars/Continuum-AI-Corp/OrcaReplay?style=social)](https://github.com/Continuum-AI-Corp/OrcaReplay) | Records a coding agent below the harness; replays the run offline or forks it onto another model | local CLI (process + socket interception), stdio MCP server | ✅ |
