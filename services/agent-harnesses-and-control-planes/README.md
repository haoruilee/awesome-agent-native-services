...
| [LoopX](loopx.md) [![⭐](https://img.shields.io/github/stars/loopx-project/loopx?style=social)](https://github.com/loopx-project/loopx) | The open, provider-neutral, stateful control plane for long-horizon agents | Objectives · gates · evidence · quota · claims/leases | CLI · workflow skills · host adapters |
