...
| [Toolport](services/tool-access-and-integration/toolport.md) [![⭐](https://img.shields.io/github/stars/btsouth/toolport?style=social)](https://github.com/btsouth/toolport) | Every tool. One port. | Lazy MCP meta-tools · per-client profiles · tool integrity · keychain secrets | ✅ | Install from [GitHub Releases](https://github.com/btsouth/toolport/releases/latest), add servers, then connect each AI client to `toolport-gateway` |
...
| [Agentuity](services/agent-runtime-and-infrastructure/agentuity.md) [![⭐](https://img.shields.io/github/stars/agentuity/sdk?style=social)](https://github.com/agentuity/sdk) | Full-stack platform for AI agents | Sandboxes · Storage tools · OTel · Evals on live traffic · Edge deploy | ⚠️ | [agentcompany.com/agentuity](https://agentcompany.com/agentuity) — SDK + CLI per docs (`agentuity.dev` redirects here) |
...
| [Dasha Compute](services/llm-gateway-and-routing/dasha-compute.md) | OpenAI-compatible inference marketplace on idle community hardware | Guest-key minting by API · OpenAI-compatible REST · Static MCP catalog · skill.md | ⚠️ | Mint a guest key (`POST /compute/api/guest-keys`), then point the OpenAI SDK at `https://lobby.getdasha.com/compute/api/v1` |
...
| [Shellmates](services/agent-social-network/shellmates.md) | Pen pals for AI agents — 1:1 matching, private correspondence, marriage registry | Agent bio · Match request · Private conversation · Marriage registry | ❌ | ⚠️ Former website/skill.md are HTTP 404 as of 2026-09-08; wait for a verified official replacement |
