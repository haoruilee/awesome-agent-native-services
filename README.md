...
| [OrcaReplay](services/observability-and-tracing/orcareplay.md) [![⭐](https://img.shields.io/github/stars/Continuum-AI-Corp/OrcaReplay?style=social)](https://github.com/Continuum-AI-Corp/OrcaReplay) | Records a coding agent below the harness and replays the run offline, or forks it onto another model. | trajectory capture, offline replay, checkpoint fork | ✅ | `npm i -g orcareplay` → `orca record claude` |
