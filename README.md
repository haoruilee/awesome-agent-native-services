...
| [AffixIO](services/commerce-and-payments/affixio.md) [![⭐](https://img.shields.io/github/stars/AffixIO/SDK?style=social)](https://github.com/AffixIO/SDK) | Host-side KYA / x402BeforePay action attestation before agent pay or tool use | x402BeforePay · agenticPay · mcpToolGate · KYA createAgentTrust | ⚠️ | `npm install affixio` - https://www.affix-io.com/agent-trust/ |
