...
<div class="service-grid">
  ...
  <article class="service-card atlas-sheet--arrival atlas-visual--08">
    ...
    <div class="service-card__copy">
    <div class="service-card__overline"><span>Curated dossier</span><span>agent-native</span></div>
    <h2 class="service-card__title">GoodMem</h2>
    <div class="service-card__actions">
      <a href="https://github.com/haoruilee/awesome-agent-native-services/blob/main/services/memory-and-state/goodmem.md">Open dossier ↗</a>
      <a href="https://github.com/PAIR-Systems-Inc/goodmem-claude-code-plugin">Official repo ↗</a>
    </div>
    </div>
  </article>
  ...
  <article class="service-card service-card--new atlas-sheet--service atlas-visual--09">
    ...
    <div class="service-card__copy">
    <div class="service-card__overline"><span>New · Last 30 days</span><span>agent-native</span></div>
    <h2 class="service-card__title">Mnemoverse</h2>
    <div class="service-card__actions">
      <a href="https://github.com/haoruilee/awesome-agent-native-services/blob/main/services/memory-and-state/mnemoverse.md">Open dossier ↗</a>
      <a href="https://github.com/mnemoverse/mcp-memory-server">Official repo ↗</a>
    </div>
    </div>
  </article>
