...
<div class="service-grid">
  <article class="service-card service-card--new atlas-sheet--service atlas-visual--01">
    ...
    <h2 class="service-card__title">Agent QA</h2>
    <div class="service-card__actions">
      <a href="https://github.com/haoruilee/awesome-agent-native-services/blob/main/services/agent-harnesses-and-control-planes/agent-qa.md">Open dossier ↗</a>
      <a href="https://github.com/vostride/agent-qa">Official repo ↗</a>
    </div>
    </div>
  </article>
  ...
  <article class="service-card atlas-sheet--service atlas-visual--03">
    ...
    <h2 class="service-card__title">Codex HUD (anhannin)</h2>
    <div class="service-card__actions">
      <a href="https://github.com/haoruilee/awesome-agent-native-services/blob/main/services/agent-harnesses-and-control-planes/codex-hud-anhannin.md">Open dossier ↗</a>
      <a href="https://github.com/anhannin/codex-hud">Official repo ↗</a>
    </div>
    </div>
  </article>
  <article class="service-card service-card--new atlas-sheet--service atlas-visual--04">
    ...
    <div class="service-card__copy">
    <div class="service-card__overline"><span>New · Last 30 days</span><span>agent-native</span></div>
    <h2 class="service-card__title">Codex HUD (fwyc0573)</h2>
    <div class="service-card__actions">
      <a href="https://github.com/haoruilee/awesome-agent-native-services/blob/main/services/agent-harnesses-and-control-planes/codex-hud-fwyc0573.md">Open dossier ↗</a>
      <a href="https://github.com/fwyc0573/codex-hud">Official repo ↗</a>
    </div>
    </div>
  </article>
  ...
  <article class="service-card service-card--new atlas-sheet--service atlas-visual--06">
    ...
    <div class="service-card__actions">
      ...
      <a href="https://github.com/AMAP-ML/LongHorizon-Harness">Official repo ↗</a>
    </div>
    </div>
  </article>
  ...
  <article class="service-card service-card--new atlas-sheet--service atlas-visual--08">
    ...
    <div class="service-card__copy">
    <div class="service-card__overline"><span>New · Last 30 days</span><span>agent-native</span></div>
    <h2 class="service-card__title">oh-my-codex (OMX)</h2>
    <div class="service-card__actions">
      <a href="https://github.com/haoruilee/awesome-agent-native-services/blob/main/services/agent-harnesses-and-control-planes/oh-my-codex.md">Open dossier ↗</a>
      <a href="https://github.com/Yeachan-Heo/oh-my-codex">Official repo ↗</a>
    </div>
    </div>
  </article>
  ...
  <article class="service-card service-card--new atlas-sheet--service atlas-visual--11">
    ...
    <div class="service-card__actions">
      ...
      <a href="https://github.com/yc-software/qm">Official repo ↗</a>
    </div>
    </div>
  </article>
  <article class="service-card service-card--new atlas-sheet--service atlas-visual--12">
    ...
    <div class="service-card__copy">
    <div class="service-card__overline"><span>New · Last 30 days</span><span>agent-native</span></div>
    <h2 class="service-card__title">Ruflo</h2>
    <div class="service-card__actions">
      <a href="https://github.com/haoruilee/awesome-agent-native-services/blob/main/services/agent-harnesses-and-control-planes/ruflo.md">Open dossier ↗</a>
      <a href="https://github.com/ruvnet/ruflo">Official repo ↗</a>
    </div>
    </div>
  </article>
  ...
  <article class="service-card atlas-sheet--service atlas-visual--14">
    ...
    <div class="service-card__copy">
    <div class="service-card__overline"><span>Curated dossier</span><span>agent-native</span></div>
    <h2 class="service-card__title">YYLO</h2>
    <div class="service-card__actions">
      <a href="https://github.com/haoruilee/awesome-agent-native-services/blob/main/services/agent-harnesses-and-control-planes/yylo.md">Open dossier ↗</a>
      <a href="https://github.com/yylo-dev/yylo">Official repo ↗</a>
    </div>
    </div>
  </article>
</div>
<nav class="collection-pagination" aria-label="Adjacent collections">
  <a href="{{ '/categories/agent-runtime-and-infrastructure/' | relative_url }}"><small>Previous collection</small><strong>← Agent Runtime & Infrastructure</strong></a>
  <a href="{{ '/categories/memory-and-state/' | relative_url }}"><small>Next collection</small><strong>Memory & State →</strong></a>
</nav>
